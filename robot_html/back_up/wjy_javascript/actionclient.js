...
var ActionClient = function(options) {
  ...
  actionClient.serverName  = options.serverName;	// /move_base
  actionClient.actionName  = options.actionName;	// move_base_msgs/MoveBaseAction
  actionClient.timeout     = options.timeout;
  actionClient.goals       = {};

  actionClient.goalTopic = new actionClient.ros.Topic({
    name        : actionClient.serverName + '/goal'	//  /move_base/goal
  , messageType : actionClient.actionName + 'Goal'	//  move_base_msgs/MoveBaseActionGoal
  });
  actionClient.goalTopic.advertise();

  actionClient.cancelTopic = new actionClient.ros.Topic({
    name        : actionClient.serverName + '/cancel'	//  /move_base/cancel
