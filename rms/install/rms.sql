...
-- --------------------------------------------------------
--
-- Table structure for table `batteryinfo`
--

CREATE TABLE IF NOT EXISTS `batteryinfos` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for the entry.',
  `topic` varchar(255) NOT NULL COMMENT 'ROS robot_status_publish/Status topic for the batteryinfo.',
  `throttle` float unsigned DEFAULT NULL COMMENT 'The throttle rate.',
 `environment_id` int(10) unsigned NOT NULL COMMENT 'The environment this stream belongs to.',
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'The time of entry creation.',
  `modified` timestamp NULL DEFAULT NULL COMMENT 'The last edited time.',
  PRIMARY KEY (`id`),
  KEY `environment_id` (`environment_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Batteryinfo settings.' AUTO_INCREMENT=2 ;

--
-- Dumping data for table `batteryinfos`
--

INSERT INTO `batteryinfos` (`id`, `topic`, `throttle`, `environment_id`, `created`, `modified`) VALUES
  (1, '/robot/status', NULL, 1, NOW(), NOW());
...
-- --------------------------------------------------------
--
-- Table structure for table `laserscans`
--

CREATE TABLE IF NOT EXISTS `laserscans` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for the entry.',
  `topic` varchar(255) NOT NULL COMMENT 'ROS topic for the laserscans.',
  `environment_id` int(10) unsigned NOT NULL COMMENT 'The environment this stream belongs to.',
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'The time of entry creation.',
  `modified` timestamp NULL DEFAULT NULL COMMENT 'The last edited time.',
  PRIMARY KEY (`id`),
  KEY `environment_id` (`environment_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='ROS laserscan settings.' AUTO_INCREMENT=2 ;

--
-- Dumping data for table `markers`
--

INSERT INTO `laserscans` (`id`, `topic`, `environment_id`, `created`, `modified`) VALUES
  (1, '/base_scan', 1, NOW(), NOW());
...
CREATE TABLE IF NOT EXISTS `gridcells` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for the entry.',
  `topic` varchar(255) NOT NULL COMMENT 'ROS topic for the gridcells.',
  `environment_id` int(10) unsigned NOT NULL COMMENT 'The environment this stream belongs to.',
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'The time of entry creation.',
  `modified` timestamp NULL DEFAULT NULL COMMENT 'The last edited time.',
  PRIMARY KEY (`id`),
  KEY `environment_id` (`environment_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='ROS gridcellss settings.' AUTO_INCREMENT=2 ;

--
-- Dumping data for table `markers`
--

INSERT INTO `gridcells` (`id`, `topic`, `environment_id`, `created`, `modified`) VALUES
  (1, '/Navigator/plan', 1, NOW(), NOW());

-- --------------------------------------------------------
--
-- Table structure for table `posearray`
--

CREATE TABLE IF NOT EXISTS `posearrays` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for the entry.',
  `topic` varchar(255) NOT NULL COMMENT 'ROS topic for the posearrays.',
  `environment_id` int(10) unsigned NOT NULL COMMENT 'The environment this stream belongs to.',
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'The time of entry creation.',
  `modified` timestamp NULL DEFAULT NULL COMMENT 'The last edited time.',
  PRIMARY KEY (`id`),
  KEY `environment_id` (`environment_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='ROS posearrays settings.' AUTO_INCREMENT=2 ;

--
-- Dumping data for table `markers`
--

INSERT INTO `posearrays` (`id`, `topic`, `environment_id`, `created`, `modified`) VALUES
  (1, '/particlecloud', 1, NOW(), NOW());
...
--
-- Constraints for table `Batteryinfos`
--
ALTER TABLE `batteryinfos`
  ADD CONSTRAINT `batteryinfos_ibfk_1` FOREIGN KEY (`environment_id`) REFERENCES `environments` (`id`);
...
--
-- Constraints for table `laserscans`
--
ALTER TABLE `laserscans`
  ADD CONSTRAINT `laserscans_ibfk_1` FOREIGN KEY (`environment_id`) REFERENCES `environments` (`id`);

--
-- Constraints for table `gridcellss`
--
ALTER TABLE `gridcells`
  ADD CONSTRAINT `gridcells_ibfk_1` FOREIGN KEY (`environment_id`) REFERENCES `environments` (`id`);

--
-- Constraints for table `posearrays`
--
ALTER TABLE `posearrays`
  ADD CONSTRAINT `posearrays_ibfk_1` FOREIGN KEY (`environment_id`) REFERENCES `environments` (`id`);
