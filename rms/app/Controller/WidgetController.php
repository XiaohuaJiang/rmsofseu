 ...
 * @var array
 */
	public $uses = array('Stream', 'Teleop', 'Tf', 'Marker', 'Im', 'Resource', 'Urdf', 'Batteryinfo', 'Laserscan', 'Posearray', 'Gridcell');
 ...
 */
	public function admin_index() {
		...
		$this->set('laserscans', $this->Laserscan->find('all', array('recursive' => 2, 'order' => 'Laserscan.environment_id')));
		$this->set('gridcells', $this->Gridcell->find('all', array('recursive' => 2, 'order' => 'Gridcell.environment_id')));
		$this->set('posearrays', $this->Posearray->find('all', array('recursive' => 2, 'order' => 'Posearray.environment_id')));
		$this->set('batteryinfos', $this->Batteryinfo->find('all', array('recursive' => 2, 'order' => 'Batteryinfo.environment_id')));
