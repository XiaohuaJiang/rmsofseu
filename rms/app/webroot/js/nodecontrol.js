...
{
	var list = document.getElementById("NodeList");	//获得NodeList元素
	...
	srv.forEach(function(srvMessage){
		...
		var tmp_detail_dialog = document.getElementById("SrvDetail");
	...
	tmp_more.onclick = function(){
		var tmp_dialog = document.getElementById("SrvDetail");
...
function component_update()		//清空状态栏后更新构件状态栏
{
	...
	list.textContent = "";	
	NodeListener.subscribe();	//重新订阅当前节点信息
}
