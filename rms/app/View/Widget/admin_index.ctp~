			...
			<div class="row">
				...
				<section class="4u">
					<a href="#resources" class="button special scrolly">Resource Servers</a>
                               ...
                               <section class="4u">
					<a href="#batteryinfos" class="button special scrolly">Batteryinfo</a>
				</section>
			</div>
			<div class="row">
				<section class="4u">
					<a href="#gridcells" class="button special scrolly">LaserScans</a>
				</section>
                               <section class="4u">
					<a href="#posearrays" class="button special scrolly">PoseArray</a>
				</section>
				<section class="4u">
					<a href="#gridcells" class="button special scrolly">gridcells</a>
				</section>
			</div>
		</section>
	</div>
	...
	<div class="content center">
		<section>
			<header>
				...
				<p>Interactive gridcells settings store information about ROS interactive gridcells topics.</p>
			</header>
			<?php
			echo $this->Html->link(
				'Create New Entry',
...
<section id="batteryinfos" class="wrapper style4 container">
	<div class="content center">
		<section>
			<header>
				<h2>Batteryinfo Settings</h2>
				<p>
					Batteryinfo settings store information about a robot_status_publish/Status topic with an optional throttle
					rate.
				</p>
			</header>
			<?php
			echo $this->Html->link(
				'Create New Entry',
				array('controller' => 'batteryinfos', 'action' => 'add'),
				array('class' => 'button')
			);
			?>
			<br /><br />
			<table>
				...
				<?php foreach ($batteryinfos as $batteryinfo): ?>
					<tr>
						<td>
							<?php
							echo $this->Form->postLink(
								'',
								array('controller' => 'batteryinfos', 'action' => 'delete', $batteryinfo['Batteryinfo']['id']),
								array('class' => 'icon fa-trash-o', 'confirm' => 'Are you sure?')
							);
							?>
							<?php
							echo $this->Html->link(
								'',
								array('controller' => 'batteryinfos', 'action' => 'edit', $batteryinfo['Batteryinfo']['id']),
								array('class' => 'icon fa-edit')
							);
							?>
						</td>
						<td data-title="ID">
							<?php echo h($batteryinfo['Batteryinfo']['id']); ?>
						</td>
						<td data-title="Topic">
							<?php echo h($batteryinfo['Batteryinfo']['topic']); ?>
						</td>
						<td data-title="Throttle">
							<?php echo ($batteryinfo['Batteryinfo']['throttle']) ? h($batteryinfo['Batteryinfo']['throttle']) : 'N/A'; ?>
						</td>
						<td data-title="Environment">
							<?php echo h($batteryinfo['Environment']['name']); ?>
						</td>
					</tr>
				<?php endforeach; ?>
			</table>
...
<section id="posearrays" class="wrapper style4 container">
	<div class="content center">
		<section>
			<header>
				<h2>Posearray Settings</h2>
				<p>Posearray settings store information about ROS 3D posearray topics.</p>
			</header>
			<?php
			echo $this->Html->link(
				'Create New Entry',
				array('controller' => 'posearrays', 'action' => 'add'),
				array('class' => 'button')
			);
			?>
			<br /><br />
			<table>
				...
				<?php foreach ($posearrays as $posearray): ?>
					<tr>
						<td>
							<?php
							echo $this->Form->postLink(
								'',
								array('controller' => 'posearrays', 'action' => 'delete', $posearray['Posearray']['id']),
								array('class' => 'icon fa-trash-o', 'confirm' => 'Are you sure?')
							);
							?>
							<?php
							echo $this->Html->link(
								'',
								array('controller' => 'posearrays', 'action' => 'edit', $posearray['Posearray']['id']),
								array('class' => 'icon fa-edit')
							);
							?>
						</td>
						<td data-title="ID">
							<?php echo h($posearray['Posearray']['id']); ?>
						</td>
						<td data-title="Topic">
							<?php
							echo $this->Html->link(
								$posearray['Posearray']['topic'],
								array('controller' => 'posearrays', 'action' => 'view', $posearray['Posearray']['id'])
							);
							?>
						</td>
						<td data-title="Environment">
							<?php echo h($posearray['Environment']['name']); ?>
						</td>
					</tr>
				<?php endforeach; ?>
			</table>
...
<section id="laserscans" class="wrapper style4 container">
	<div class="content center">
		<section>
			<header>
				<h2>Laserscan Settings</h2>
				<p>Laserscan settings store information about ROS 3D laserscan topics.</p>
			</header>
			<?php
			echo $this->Html->link(
				'Create New Entry',
				array('controller' => 'laserscans', 'action' => 'add'),
				array('class' => 'button')
			);
			?>
			<br /><br />
			<table>
				...
				<?php foreach ($laserscans as $laserscan): ?>
					<tr>
						<td>
							<?php
							echo $this->Form->postLink(
								'',
								array('controller' => 'laserscans', 'action' => 'delete', $laserscan['Laserscan']['id']),
								array('class' => 'icon fa-trash-o', 'confirm' => 'Are you sure?')
							);
							?>
							<?php
							echo $this->Html->link(
								'',
								array('controller' => 'laserscans', 'action' => 'edit', $laserscan['Laserscan']['id']),
								array('class' => 'icon fa-edit')
							);
							?>
						</td>
						<td data-title="ID">
							<?php echo h($laserscan['Laserscan']['id']); ?>
						</td>
						<td data-title="Topic">
							<?php
							echo $this->Html->link(
								$laserscan['Laserscan']['topic'],
								array('controller' => 'laserscans', 'action' => 'view', $laserscan['Laserscan']['id'])
							);
							?>
						</td>
						<td data-title="Environment">
...
<section id="gridcells" class="wrapper style4 container">
	<div class="content center">
		<section>
			<header>
				<h2>Gridcell Settings</h2>
				<p>Gridcell settings store information about ROS 3D gridcell topics.</p>
			</header>
			<?php
			echo $this->Html->link(
				'Create New Entry',
				array('controller' => 'gridcells', 'action' => 'add'),
				array('class' => 'button')
			);
			?>
			<br /><br />
			<table>
				...
				<?php foreach ($gridcells as $gridcell): ?>
					<tr>
						<td>
							<?php
							echo $this->Form->postLink(
								'',
								array('controller' => 'gridcells', 'action' => 'delete', $gridcell['Gridcell']['id']),
								array('class' => 'icon fa-trash-o', 'confirm' => 'Are you sure?')
							);
							?>
							<?php
							echo $this->Html->link(
								'',
								array('controller' => 'gridcells', 'action' => 'edit', $gridcell['Gridcell']['id']),
								array('class' => 'icon fa-edit')
							);
							?>
						</td>
						<td data-title="ID">
							<?php echo h($gridcell['Gridcell']['id']); ?>
						</td>
						<td data-title="Topic">
							<?php
							echo $this->Html->link(
								$gridcell['Gridcell']['topic'],
								array('controller' => 'gridcells', 'action' => 'view', $gridcell['Gridcell']['id'])
							);
							?>
						</td>
						<td data-title="Environment">
