...
<head>
	...
	<?php if(!isset($style) || $style): ?>
		<noscript>
			<?php echo $this->Html->css(array('skel', 'style', 'style-noscript', 'jquery-ui-1.10.3.custom', 'jquery-ui-1.10.3.custom.min', 'demo.css', 'advanceset.css')); ?>
		</noscript>
