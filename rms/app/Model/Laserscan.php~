 ...
 * Laserscans Model
 *
 * Laserscans represent ROS 3D laserscan settings. It contains information about the ROS topic.
 *
 ...
 * @package		app.Model
 */
class Laserscan extends AppModel {
...
/**
 * All laserscans belong to a single environment.
 *
 * @var string
 */
